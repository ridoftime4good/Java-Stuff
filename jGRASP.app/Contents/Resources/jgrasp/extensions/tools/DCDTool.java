   ...
   public class DCDTool implements Tool {
      ...
      private ToolAction checkFileAction = 
         new ToolAction() {
            ...
            public String getMenuName() {
               return "Find Dead Code in Current Directory";
            }
            ...
            public URL getToolbarIconURL() {
               return DCDTool.class.getResource("dcd.png");
            }
            ...
            public String getToolbarHint() {
               return "Find dead code in parent directory of file";
            }
      ...
      private ToolAction checkProjectAction = 
         new ToolAction() {
            ...
            public String getMenuName() {
               return "Find Dead Code in Project Directories";
            }
            ...
            public URL getToolbarIconURL() {
               return DCDTool.class.getResource(
                     "dcd.png");
            }
            ...
            public String getToolbarHint() {
               return "Find dead code in project directories and jar files";
            }
      ...
      private void executeCommand(final List<File> files,
         ...
         File cfgFile = creationData.createTmpFile(context.getDialogParent(),
               "dcd", null, cfg.toString(), "DCD");
         if (cfgFile == null) {
            return;
         }
      
         File jarFile = settings.getDCDJar();
         ...
         context.executeCommand(command.toString(), ExecType.CHECK,
               ...
               null, null, null, DateTestType.TARGETS, files);
