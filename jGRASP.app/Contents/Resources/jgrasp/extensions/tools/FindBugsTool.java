   ...
   public class FindBugsTool implements Tool {
      ...
      private ToolAction checkFileAction = 
         new ToolAction() {
            ...
            public URL getToolbarIconURL() {
               return FindBugsTool.class.getResource("findbugs.png");
            }
      ...
      private ToolAction checkProjectAction = 
         new ToolAction() {
            ...
            public String getMenuName() {
               return "Find Bugs in Project Files";
            }
            ...
            public URL getToolbarIconURL() {
               return FindBugsTool.class.getResource(
                     "findbugs.png");
            }
            ...
            public String getToolbarHint() {
               return "Run FindBugs on project files";
            }
      ...
      private void executeCommand(final List<File> files,
         ...
         context.executeCommand(command.toString(), ExecType.CHECK,
               ...
               "CLASSPATH=" + getRunClasspath(files) + "\n"
               + "PATH+=%<JAVA_BIN_DIR>%:\n"
               + "PATH+=%<JGRASP_PATHS>%:", "FindBugs", h, null,
               null, null, DateTestType.TARGETS, files);
      }
